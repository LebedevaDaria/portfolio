...
const translations = {
  en: {
   ...
   "I design clear, reliable interfaces for complex products and technical workflows, combining UX thinking, systems thinking, and an engineering mindset.",
    ...
    contactTitle:
      ...
      autogradingText2:
      "I used support feedback to identify user questions and pain points, then worked with product and analytics teammates from low-fidelity structure to the final interface.",

      autogradingText3:
      "The result explains the grading workflow, guides users through the process, and makes support information easy to find.",
      ...
      robotTitle:
      "Device Grading Touchscreen Interface",
  ...
  ru: {
    ...
    heroText:
      'UX/UI-дизайнер с инженерным бэкграундом. Проектирую <strong>B2B-продукты</strong> и интерфейсы с <strong>большим объёмом данных</strong>, превращая  сложную логику и насыщенную информацию в понятный пользовательский опыт.',
   ...
   statusCompleted:
    ...
    aboutText:
    "Работаю со сложными продуктами и техническими сценариями, помогая превратить их в понятные и логичные интерфейсы. В работе опираюсь на UX, системное мышление и инженерный подход.",
    ...
    contactTitle:
      ...
      contactText:
      "Буду рада обсудить позиции и проекты в продуктовом дизайне, совместную работу и интересные задачи на стыке дизайна и технологий.",
      ...
      analyticsText1:
      "Внутренняя аналитическая платформа для отслеживания активности клиентов, использования лицензий и продуктов.",

      analyticsText2:
      "Совместно с аналитиком данных я спроектировала систему дашбордов с нуля: перевела бизнес-требования в понятные представления данных, продумала многоуровневую фильтрацию и сортировку, а также таблицы с возможностью экспорта.",

      analyticsText3:
      "Интерфейс позволяет гибко исследовать данные и быстро формировать отчётность с учётом существующей библиотеки компонентов и технических ограничений.",

      selfServiceTitle:
      "Приложение для управления устройствами самообслуживания",

      selfServiceText1:
      "Мобильное B2B-приложение для владельцев и операторов устройств самообслуживания, подключённых к единой платформе платежей и мониторинга.",

      selfServiceText2:
      "Я продумала сквозной пользовательский сценарий: выручку и способы оплаты, суммы к инкассации, статусы устройств и технические проблемы.",

      selfServiceText3:
      "Интерфейс помогает быстро понять, что происходит на каждой локации, и определить, какие устройства требуют внимания.",

      autogradingTitle:
      "Онбординг для Autograding System",

      autogradingText1:
      "Welcome-страница для ML-платформы автоматической оценки мобильных устройств. Её задача — объяснить, что это за продукт, для чего он нужен и как им пользоваться, сократив необходимость ручного обучения клиентов.",

      autogradingText2:
      "Я проанализировала обратную связь от поддержки, выделила основные вопросы и проблемные места пользователей, а затем вместе с продуктовой и аналитической командами прошла путь от низкодетальной структуры до финального интерфейса.",

      autogradingText3:
      "В результате страница знакомит пользователя с продуктом, объясняет процесс оценки, проводит по основным шагам и помогает быстро найти информацию по поддержке.",

      trackerTitle:
      "Командные таймеры и трекеры",

      trackerText1:
      "Веб-сервис для работы с переиспользуемыми таймерами и трекерами: их можно создавать, запускать, редактировать и отслеживать.",

      trackerText2:
      "Моей задачей было продумать логику взаимодействия и состояния интерфейса — сделать понятными текущий статус, оставшееся время и доступные действия.",

      trackerText3:
      "Помимо дизайна, я участвовала во фронтенд-реализации, чтобы поведение готового интерфейса соответствовало проектному решению.",

      robotTitle:
      "Сенсорный интерфейс системы оценки девайсов",

      robotText1:
      "Сенсорный интерфейс для системы автоматической оценки внешнего и технического состояния мобильных устройств.",

      robotText2:
      "Система объединяет съёмку устройства с разных ракурсов, ML-оценку косметического состояния и набор технических тестов.",

      robotText3:
      "При проектировании я учитывала особенности работы с сенсорным экраном: последовательный сценарий для оператора, удобные для взаимодействия элементы управления, наглядный прогресс и подробные результаты тестирования.",
